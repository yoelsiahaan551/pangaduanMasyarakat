  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5">
        {[
          { label: "Total Pengaduan", value: stats.total, icon: <FaClipboardList />, color: "slate" },
          { label: "Menunggu", value: stats.menunggu, icon: <FaClock />, color: "yellow" },
          { label: "Diproses", value: stats.diproses, icon: <FaSpinner />, color: "blue" },
          { label: "Selesai", value: stats.selesai, icon: <FaCheckCircle />, color: "green" },
          { label: "Ditolak", value: stats.ditolak, icon: <FaTimesCircle />, color: "red" },
        ].map((stat, index) => (
          <motion.div
            key={index}
            variants={fadeUp}
